...
export const Route = createFileRoute("/mukofotlar")({
  head: () => ({
    meta: [
      { title: "Mukofotlar — Hashimjon Akademiyasi" },
      { name: "description", content: "Nishonlar, sertifikatlar va sovg'alar." },
    ],
  }),
  component: () => (
      ...
      <section className="relative isolate flex min-h-[70vh] items-center justify-center overflow-hidden px-6 pt-32 text-center">
        ...
        <div className="relative mx-auto max-w-2xl">
          <h1 className="text-balance text-6xl font-extrabold tracking-tight text-white sm:text-7xl">
            <span className="text-gradient-sunset">🎁 Mukofotlar</span>
          </h1>
          <p className="mx-auto mt-6 max-w-xl text-lg text-white/75">
            Har bir dars sizni yangi sovg'alar sari olib boradi.
          </p>
